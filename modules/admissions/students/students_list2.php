...
//fee for new students -admission & uniform
  ...
  $resulta   = mysql_query($sql) or die('Cannot get Info7.');
...
$result2   = mysql_query($sql2) or die('Cannot get Info7.');
...
$result3   = mysql_query($sql3) or die('Cannot get Info7.');
$typearray =array();
