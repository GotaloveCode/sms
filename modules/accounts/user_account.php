...
<table width="200" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
		...
		<td width="150" class="label">Full Name<span style="color:red;" >*</span></td>
			...
			$nt0=mysql_fetch_assoc($result0);//Array or records stored in $nt
			extract($nt0);
        ...
        <tr>
            <td width="150" class="label">Username</td>  
 			<td class="content"><?php 
					...
					$nt3=mysql_fetch_assoc($result3);//Array or records stored in $nt
					extract($nt3);	 
			?>
...
mysql_query($insert) or die("User Registration failed<br/>".mysql_error());
...
mysql_query($insert) or die("User Account Update failed<br/>".mysql_error());
